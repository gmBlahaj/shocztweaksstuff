...
fltmc >nul 2>&1
if not %errorlevel% == 0 (
    powershell -Command "Write-Host 'Its required to be run as *Administrator.*' -ForegroundColor White -BackgroundColor Red" 
    timeout 3 > nul
...
if !build_num! GEQ 26100 (
    powershell -Command "Write-Host 'Windows 11 24H2 detected' -ForegroundColor White -BackgroundColor Red"
    powershell -Command "Write-Host 'Use Windows 11 22H2 or 23H2!' -ForegroundColor White -BackgroundColor Red"
    Pause
    exit
    ...
    powershell -Command "Write-Host 'Windows 11 not detected' -ForegroundColor White -BackgroundColor Red"
    pause
)
endlocal

:: Check if TrustedInstaller is disabled, for Nsudo.
...
set "fileURL=https://raw.githubusercontent.com/gmBlahaj/shocztweaksstuff/main/ShoczTools.zip"
set "fileName=Shocz Tools.zip"
set "extractFolder=C:\Shocz Tools"
...
if not exist "%downloadsFolder%\%fileName%" (
    ...
    popd >nul 2>&1
    del /q "C:\Shocz Tools.zip" >nul 2>&1
) else (
...
if not errorlevel 1 (
    powershell -Command "Write-Host 'Windows Defender is Enabled' -ForegroundColor White -BackgroundColor Red"
    echo.
    goto :Defender
) else ( 
    goto :OSS
...
echo Disable Windows Defender
    ...
    if /i "%choice%"=="Y" (
    cls
    powershell -Command "Write-Host 'Turn Off Virus & Threat Protection.' -ForegroundColor White -BackgroundColor Red"
...
if /i "%choice%"=="Y" (
    ...
    powershell -Command "Checkpoint-Computer -Description 'Shocz Restore Point'"
    echo Restore point successfully created.
    timeout 2 > nul 
) else if /i "%choice%"=="N" (
    echo ________________________________________________
    echo Not creating a restore point.
    timeout 2 > nul
) else (
    cls
    powershell -Command "Write-Host 'Invalid choice, Please choose Y or N.' -ForegroundColor White -BackgroundColor Red"
...
echo. 
echo.                                  ╔════════════════════════════════════════════════════╗
echo.                                  ║           Running CTT's Windows Utility...         ║       
echo.                                  ╚════════════════════════════════════════════════════╝
echo.
echo.
echo.                                                                          
...
cls
color 9
echo Running OOshutup10 with imported optimized settings...
set "exePath=C:\Shocz Tools\OOshutup10\OOSU10.exe"
set "cfgPath=C:\Shocz Tools\OOshutup10\ShoczOOshutup10.cfg"
chcp 65001 >nul 2>&1
echo.
echo ╔═════════════════════════════╗
echo ║                             ║
...
color D
chcp 437 >nul
echo Disabling Regular Services...
timeout 1 > nul
...
cls
color D
echo Disabling Browsers Services...
...
"C:\Shocz Tools\NSudo\NSudoLG.exe" -ShowWindowMode:hide -U:T -P:E "C:\Shocz Tools\Amd\AMD.bat"
...
cls
color D
echo Disabling Manufacturer/Prebuild Services...

:: Sound Bloat | NSudo needed to disable! | Deletes Realtek, Sound Research and VisiSonics bloat.
"C:\Shocz Tools\NSudo\NSudoLG.exe" -ShowWindowMode:hide -U:T -P:E "C:\Shocz Tools\Sound\Sound.bat"
...
cls
color D
echo Disabling and Deleting Unnecessary Tasks...

:: Orca/UpdateOrchestrator Bloat, NSudo needed to disable! | Deletes UpdateOrchestrator task.
"C:\Shocz Tools\NSudo\NSudoLG.exe" -ShowWindowMode:hide -U:T -P:E "C:\Shocz Tools\Orca\Orca.bat"
...
cls
color 9
echo Removing UsoCoreWorker and UsoClient...
...
cls
color D
echo Enabling the Network Adapters On-Board Processor...
...
cls
color 9
echo Removing Windows Search and Installing alternative called "Open Shell Menu"...
echo.
chcp 437 >nul
powershell -Command "Write-Host 'Can only get search back by system restoring.' -ForegroundColor White -BackgroundColor Red" 
echo.
echo Windows Search Removal
echo Leads to a reduction of 4-6 processes, and a installation of  "Open Shell"!
echo.
set /p choice=Enter (Y/N): 
echo.
if /i "%choice%"=="Y" (
    ...
    echo Skipping Search Removal and Open Shell Install! 
    timeout 2 > nul
...
cls
color 9
echo Installing Alternative Search/Open Shell Menu...
...
mkdir "C:\Shocz Tools\Open Shell" >nul 2>&1
set "downloadsFolder=C:\Shocz Tools\Open Shell"
chcp 65001 >nul 2>&1
echo.
echo ╔═════════════════════════════╗
echo ║                             ║
...
cls
color D
echo Auto Setting Windows Processes Priority... 
...
set "fileURL2=https://raw.githubusercontent.com/gmBlahaj/shocztweaksstuff/refs/heads/main/shocz.nip"
set "fileName2=shocz.nip"
mkdir "C:\Shocz Tools\Nvidia" >nul 2>&1
set "extractFolder=C:\Shocz Tools\Nvidia\nvidiaProfileInspector"
set "downloadsFolder=C:\Shocz Tools\Nvidia"
chcp 65001 >nul 2>&1
echo.
echo ╔═════════════════════════════╗
echo ║                             ║
...
color D
chcp 437 >nul
echo Applying System Clock Settings...
...
mkdir "C:\Shocz Tools\VC Redist" >nul 2>&1
set "downloadsFolder=C:\Shocz Tools\VC Redist"
chcp 65001 >nul 2>&1
echo.
echo ╔═════════════════════════════╗
echo ║                             ║
...
echo.
chcp 437 >nul
powershell -Command "Write-Host 'Can cause bluescreens and other issues' -ForegroundColor White -BackgroundColor Red"
echo.
set /p choice=Enter (Y/N): 
if /i "%choice%"=="Y" (
    timeout 1 > nul
...
:DeviceManagerTweaks
echo Disabling unnecessary devices in Device Manager...
setlocal enabledelayedexpansion
...
:DisableWifiDevices
cls
echo Disable Wifi Devices
echo.
chcp 437 >nul
powershell -Command "Write-Host 'Breaks Wifi' -ForegroundColor White -BackgroundColor Red"
echo.
...
echo. 
echo Choose an option:
echo 1. Shocz Ultimate Performance
echo 2. Shocz Ultimate Performance Idle Off 
echo 3. ACPI FIX
echo 4. Skip!
set /p option="Enter option number: "
if "%option%"=="1" (
  echo.
  powercfg -import "C:\Shocz Tools\Power Plan\Shocz Ultimate Performance.pow"
  timeout 1 > nul
  goto :Activatecpl
) else if "%option%"=="2" (
  echo. 
  powercfg -import "C:\Shocz Tools\Power Plan\Shocz Ultimate Performance Idle Off.pow"
  timeout 1 > nul
  goto :Activatecpl
) else if "%option%"=="2" (
  echo. 
  powercfg -import "C:\Shocz Tools\Power Plan\ACPIFix.pow"
  timeout 1 > nul
  goto :Activatecpl
) else if "%option%"=="4" (
  echo.
...
:: Checking if Ultimate Performance power plan exists.
for /f "tokens=2 delims=:(" %%i in ('powercfg /list ^| findstr /C:"Shocz Ultimate Performance"') do (
    set plan_guid=%%i
)

:: Checking if Ultimate Performance Idle Off power plan exists.
for /f "tokens=2 delims=:(" %%i in ('powercfg /list ^| findstr /C:"Shocz Ultimate Performance Idle Off"') do (
    set idle_off_guid=%%i
)
...
rd /s /q "C:\Shocz Tools\Amd" >nul 2>&1
rd /s /q "C:\Shocz Tools\NSudo" >nul 2>&1
rd /s /q "C:\Shocz Tools\Nvidia" >nul 2>&1
rd /s /q "C:\Shocz Tools\OOshutup10" >nul 2>&1
rd /s /q "C:\Shocz Tools\Open Shell" >nul 2>&1
rd /s /q "C:\Shocz Tools\Orca" >nul 2>&1
rd /s /q "C:\Shocz Tools\Power Plan" >nul 2>&1
rd /s /q "C:\Shocz Tools\Sound" >nul 2>&1
rd /s /q "C:\Shocz Tools\VC Redist" >nul 2>&1
...
echo.                         ╔═════════════════════════════════════════════════════════════════════╗ 
echo.                         ║                                                                     ║ 
echo.                         ║           [1] Reenable Wifi           [2] Kernel Tweaks             ║
echo.                         ║                                                                     ║
echo.                         ║           [3] BufferBloat             [4] P-State                   ║
echo.                         ║                                                                     ║
echo.                         ║           [5] Lower Processes         [6] Cleanup                   ║
echo.                         ║                                                                     ║
echo.                         ╚═════════════════════════════════════════════════════════════════════╝
echo.  
echo.  
echo.
set /p input=:
if /i %input% == 1 goto WifiFixer
if /i %input% == 2 goto IntS
if /i %input% == 3 goto BB
if /i %input% == 4 goto PST
if /i %inout% == 5 goto LP
...
echo The operation completed successfully.
echo The operation completed successfully.
echo Kernel Tweaks ran sucessfully.
timeout 2 > nul
goto :Extra
...
echo The operation completed successfully.
echo The operation completed successfully.
echo Bufferbloat was successfully reduced.
timeout 2 > nul
goto :Extra
...
cls
color D
echo NVIDIA Highest Performance Power State
pause
set "regPath=HKLM\SYSTEM\CurrentControlSet\Control\Class\{4d36e968-e325-11ce-bfc1-08002be10318}"
if exist "%regPath%\0000" (
    set "subKey=0000"
    reg add "%regPath%\%subKey%" /v "DisableDynamicPstate" /t REG_DWORD /d "1" /f
) else if exist "%regPath%\0001" (
    set "subKey=0001"
    reg add "%regPath%\%subKey%" /v "DisableDynamicPstate" /t REG_DWORD /d "1" /f
) else if exist "%regPath%\0002" (
    set "subKey=0002"
    reg add "%regPath%\%subKey%" /v "DisableDynamicPstate" /t REG_DWORD /d "1" /f
) else (
    echo No valid path found. The script is being stopped.
    goto :Extra
)
cls
echo The operation completed successfully.
echo The operation completed successfully.
echo Disabled P0 sucessfully.
timeout 2 > nul
goto :Extra
...
cls
color B
echo Excuting Processes With NSudo...
"C:\Shocz Tools\NSudo\NSudoLG.exe" -ShowWindowMode:Show -U:T -P:E "C:\Shocz Tools\Processes\Processes.bat"
...
echo Restarting the PC to apply all tweaks!
